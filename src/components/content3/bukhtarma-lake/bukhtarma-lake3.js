	...
	return (
		<div className="lake1-container3">
			...
			<div className="lake-image3">
				<div class="wrapper-5-2">
					<input type="radio" name="point" id="slide1-5-2" checked/>
					<input type="radio" name="point" id="slide2-5-2" checked/>
					<input type="radio" name="point" id="slide3-5-2" checked/>
					<input type="radio" name="point" id="slide4-5-2" checked/>
					<input type="radio" name="point" id="slide5-5-2" checked/>
					<div class="slider-5-2">
						<div class="slides-5-2 slide1-5-2"></div>
						<div class="slides-5-2 slide2-5-2"></div>
						<div class="slides-5-2 slide3-5-2"></div>
						<div class="slides-5-2 slide4-5-2"></div>
						<div class="slides-5-2 slide5-5-2"></div>
					</div>
					<div class="controls-5-2">
						<label for="slide1-5-2"/>
						<label for="slide2-5-2"/>
						<label for="slide3-5-2"/>
						<label for="slide4-5-2"/>
						<label for="slide5-5-2"/>
					</div>
				</div>
			</div>
		</div>
